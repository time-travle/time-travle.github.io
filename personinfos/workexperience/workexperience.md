...
## 2024.09.03 - 今   玫德集团有限公司
- 公司官网 :
  https://www.meide-casting.com/
### 简介

### 工作内容

    描述：
      1、主要负责公司内部IOT平台基础功能开发，公司内部设备接入IOT平台，IOT平台使用制度规定制定以及日常使用和问题维护；
      2、负责公司内部数据集成平台日常维护和新功能开发，对接公司内部其他各个业务系统，实现不同系统间数据传递，制定书数据集成平台使用制度；
      3、除却支持公司内部项目运作外，同时支持已经出售的平台的支持。
    成果：
      1、IOT平台第二版从0搭建开始到完成MQTT设备直连平台；
      2、IOT平台后续设备持续接入平台(HJ212协议、Modbus设备、MQTT设备)；
      3、IOT平台系统权限控制优化、租户功能开发；
      4、多次演进数据集成平台功能，先后加入PG数据库支持，数据同步告警通知；
      5、优化数据集成平台离线任务运行速度，引入XXL-JOB调度中心支持离线同步任务；
      6、先后制定IOT平台使用管理规定和数据集成平台管理规定；
      7、搭建数据集成平台知识库。



## 2024.05.01 - 2024.09.01 山东久智信息技术有限公司(3个月后转 山东恩熙信息技术有限公司)
      主要负责浪潮信息MES系统开发，涉及4个厂区：孙村工厂、美国工厂、越南工厂、贵阳工厂
### 工作内容
          描述：
            负责浪潮信息MES系统功能开发。
            负责对接MES系统对应的外地产线经理，梳理外地产线需求，完成功能异地升级。
            对接生产产线，处理生产产线日常问题。
            搭建部门内部任务调度中心和多个产线间数据汇总同步服务。
            
          成果：
            搭建部门任务调度中心和数据集成同步平台系统
            完成MES系统中产品维修筛选功能优化，便于产线操作工人使用
            完成MES系统中锐捷产品扫描校验，同时完成 订单号码、产品SN号码、锐捷SN、箱号 四码合一查询功能
            完成MES系统BOM列表中物料模块化显示，优化工单、制令单、数据扫码采集、品质检验以及首检使用体验
            完成包装可生产物料工序功能重优化，使得工人使用更方便
            完成MES系统摄像头加载按照配置自动加载摄像头进行拍照功能，涉及到摄像头包括电脑自带和海康高清摄像头
            完成MES系统未完成订单切换订单控制功能
